...
the selected path. Source has a solid green outline and destination a dashed
red outline. Set bandwidth (1–1000 Mbps), one-way delay (0–500 ms), loss
(0–20%), ping count (1–20), and iperf duration (1–30 seconds).

Dry-run is the default: click **Validate**, then **Run** to create an isolated
artifact directory without Docker. For a real Docker run choose direct,
